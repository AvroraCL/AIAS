...
从贴图到可用涂装：**合成 PBR 通道**生成 `_c` / `_n` DDS → **生成 BLK**关联游戏原贴图 → **检查与管理涂装**。需要智能材质时，还可从静态模型烘焙 AO、法线、曲率等 Mesh Maps。上图使用程序生成的示例 DDS，展示实际工作区。
...
| 文件 | 说明 |
|---|---|
| [AIAS_5.7.1_x64-setup.exe](https://github.com/AvroraCL/AIAS/releases/download/v5.7.1/AIAS_5.7.1_x64-setup.exe) | Windows 安装包，按当前用户安装无需管理员权限 |
